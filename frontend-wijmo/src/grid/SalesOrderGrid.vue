<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['salesOrderNumber','salesPerson','salesType','salesItems','companyId',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="salesOrderNumber" header="salesOrderNumber" width="2*" :isReadOnly="true" align="center" />
            ...
            <wj-flex-grid-column binding="salesItems" header="salesItems" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
        <v-col>
            <v-dialog
                v-model="openDialog"
